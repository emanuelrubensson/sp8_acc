...
ax_slope.set_xlabel(r'$\mu$')
ax_slope.set_ylabel(r"$p_{(L,R,\mu-\varepsilon,\mu+\varepsilon)}'(\mu)$")
...
ax_map.set_xlabel(r'$\mu$')
ax_map.set_ylabel(r"$p_{(L,R,\mu-\varepsilon,\mu+\varepsilon)}(\mu)$")
