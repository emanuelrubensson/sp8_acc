...
plot_convergence_sp5(X0, D, Z, L_outer, L_inner, H_inner, H_outer, ax1, ax2, 'x', 'tab:orange', 'solid', 'SP5-ACC')
plot_convergence_sp5(X0, D, Z, 0.0, L_inner, H_inner, 1.0, ax1, ax2, 'x', 'tab:orange', 'dashed', 'SP5')
